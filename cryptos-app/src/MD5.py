...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MD5 Hashing Tool")
    parser.add_argument("--operation", type=str, required=True, choices=["hash"], help="Operation to perform: hash")
    parser.add_argument("--input", type=str, required=True, help="Input string to hash")
    args = parser.parse_args()

    try:
        if args.operation == "hash":
            md5 = MD5()
            md5.update(args.input)
