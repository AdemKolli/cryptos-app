...
if __name__ == "__main__":  
    parser = argparse.ArgumentParser(description="AES-128 encryption and decryption implementation")  
    ...
    parser.add_argument("--key", type=str, required=True, help="Encryption key (16 characters)")  
