...
class VigenereToolWidget extends StatefulWidget {
  const VigenereToolWidget({super.key});

  @override
  State<VigenereToolWidget> createState() => _VigenereToolWidgetState();
}

class _VigenereToolWidgetState extends State<VigenereToolWidget> {
