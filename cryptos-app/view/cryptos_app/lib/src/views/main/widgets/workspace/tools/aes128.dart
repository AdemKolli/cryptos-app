...
class AES128ToolWidget extends StatefulWidget {
  const AES128ToolWidget({super.key});

  @override
  State<AES128ToolWidget> createState() => _AES128ToolWidgetState();
}

class _AES128ToolWidgetState extends State<AES128ToolWidget> {
  ...
  void _showDocumentationDialog() async {
    final markdownContent = await DefaultAssetBundle.of(context)
        .loadString('assets/docs/aes128.md');
        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  "AES 128 bit Key Encoder | Decoder",
